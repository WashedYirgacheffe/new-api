...
export const apiKeySchema = z.object({
  ...
  model_type_limits_enabled: z.boolean().optional().default(false),
  model_type_limits: z.string().nullish().default(''),
...
export interface ApiKeyFormData {
  ...
  model_limits: string
  model_type_limits_enabled: boolean
  model_type_limits: string
  allow_ips: string
  group: string
