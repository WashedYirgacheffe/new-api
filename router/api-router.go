...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/subsites/by-domain/:domain/catalog", middleware.TokenAuth(), controller.GetSubsiteCatalogByDomain)
		apiRouter.GET("/subsites/claimable", middleware.SubsiteAdminAuth(), controller.GetClaimableSubsites)
		apiRouter.POST("/subsites/claim", middleware.SubsiteAdminAuth(), middleware.CriticalRateLimit(), controller.ClaimSubsite)
		apiRouter.GET("/subsites/:code/models", middleware.SubsiteAdminAuth(), controller.GetSubsiteModels)
		apiRouter.PUT("/subsites/:code/models", middleware.SubsiteAdminAuth(), controller.UpdateSubsiteModels)
		apiRouter.GET("/subsites", middleware.SubsitePlatformAdminAuth(), controller.GetSubsites)
		apiRouter.POST("/subsites", middleware.SubsitePlatformAdminAuth(), controller.CreateSubsite)
		apiRouter.PUT("/subsites/:code", middleware.SubsitePlatformAdminAuth(), controller.UpdateSubsite)
		apiRouter.DELETE("/subsites/:code", middleware.SubsitePlatformAdminAuth(), controller.DeleteSubsite)
